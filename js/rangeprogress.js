...
$(function(){
	$('#loan_amount').rangeslider({
		polyfill:false,
		onInit:function(){
			$('#amount').text('₹'+$('#loan_amount').val());
		},
		onSlide:function(position, value){
			$('#amount').text('₹'+value);
      $("#amount").attr('value', value);
      $("#loan_amount").attr('value', value);
		},
	});
});

$(function(){
	$('#insert_rate').rangeslider({
		polyfill:false,
		onInit:function(){
			$('#rate').text($('#insert_rate').val()+"%");
		},
		onSlide:function(position, value){
			$('#rate').text(value + "%");
      $("#rate").attr('value', value);
      $("#insert_rate").attr('value', value);
		},
	});
});
...
$(function(){
	$('#years').rangeslider({
		polyfill:false,
		onInit:function(){
			$('#year').text($('#years').val()+" year");
		},
		onSlide:function(position, value){
			$('#year').text(value + " year");
      $("#year").attr('value', value);
      $("#years").attr('value', value);
		},
	});
});
